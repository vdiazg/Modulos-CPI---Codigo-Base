...
<div id="maincontent">
  <form method="get"  action="" name="form">
   <input type="hidden" id = "archivo" value="buscar_entradas_material.php?" />
    <div class="normal" align="center">Consultar Entradas de Material </div> 
...
if($total_records > 0)
	{ 
?>
<div class="normal" align="right"><a href="javascript:Exportar_Excel('excel/excel_entradas_material.php?desde=<?php echo $desde; ?>& hasta=<?php echo $hasta;?>','ventana')"><img src="../imagenes/excel.jpg" /></a></div>
<table width="873">
